...
<body>
	...
	<div class="container">
		<div class="page-header">
			...
			if ($isStudentHead)
				echo anchor('announcement/add', $button, array('class' => 'btn btn-primary btn-md pull-right'));
			?>
			Announcements</h1>
		</div>
		<div class="col-sm-10 col-sm-offset-1">
			<div class="row">
				...
				<?php
				if( $aList == FALSE || isset($aList) == FALSE || $aList == "" ){
					echo"<h2>There are no Events</h2>";
				}else
				{
					foreach ($aList as $dataEntry): 
						$id = $dataEntry['pk'];
					$title = $dataEntry['announcement'];
					...
					<div class="col-sm-6">
						...
						<div class="panel-footer">
								<?php $this->load->view('common/edit_options', array('pull_right' => FALSE, 'edit' => 'announcement/edit/' . $id, 'remove' => 'announcement/delete/' . $id));  ?>
						</div>
						<?PHP endif; ?>
					</div>
				</div>
