		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						echo form_open('admin/editedClass/'.$class['pk'], $attr); ?>
						<input type="hidden" id="classFaciId" name="classFaciId">
						<div class="form-group">
							<label for="section" class="col-sm-1 control-label">Section</label>
							<div class="col-sm-11">
								<input type="text" class="form-control" id="section" name="section" value =<?= "'".$class['section']."'"?> required autofocus >
							</div>
						</div>
						<div class="form-group">
							<label for="venue" class="col-sm-1 control-label">Venue</label>
							<div class="col-sm-11">
								<input type="text" class="form-control" id="venue" name="venue" value =<?= "'".$class['venue']."'"?> required>
							</div>
						</div>
						<div class="form-group">
							<label for="day" class="col-sm-1 control-label">Day</label>
							<div class="col-sm-11">
								<input type="text" class="form-control" id="day" name="day" value =<?= "'".$class['day']."'"?> required>
							</div>
						</div>
						<div class="form-group">
							<label for="timeStart" class="col-sm-1 control-label">Start Time</label>
							<div class="col-sm-11">
								<input type="time" class="form-control" id="timeStart" name="timeStart" value =<?= "'".$class['timeStart']."'"?>required>
							</div>
						</div>
						<div class="form-group">
							<label for="timeEnd" class="col-sm-1 control-label">End Time</label>
							<div class="col-sm-11">
								<input type="time" class="form-control" id="timeEnd" name="timeEnd" value =<?= "'".$class['timeEnd']."'"?> required>
							</div>
						</div>
						<div class="form-group">
							<label for="faci" class="col-sm-1 control-label">Class Faci</label>
							<div class="col-sm-11">
								<input type="text" class="form-control" id="faci" name="faci" value =<?= "'".$class['classFaciName']."'"?> required>
							</div>
						</div>
						<div class="form-group">
