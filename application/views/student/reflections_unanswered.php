...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1>Chapter 2: The Life of John De La Salle <small></small></h1>
    </div>
	
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Nobel Origins</h3>
  </div>
...
<div class="input-group">
  ...
  <input type="text" class="form-control" placeholder="What course did De La Salle take?">
</div>

<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">The Sisters of the Child Jesus</h3>
  </div>
  <div class="panel-body">
...
<div class="input-group">
  <span class="input-group-addon">Answer</span>
  <input type="text" class="form-control" placeholder="What was the charter of the Sisters">
</div>
